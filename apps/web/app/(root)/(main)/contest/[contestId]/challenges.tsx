  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8 flex flex-col gap-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-white/10">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Contest Challenges</h1>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h2 className="text-lg sm:text-xl font-semibold tracking-tight text-foreground/90">Available Challenges</h2>
          <Button
            onClick={() => {

...
export default function ContestSearchAndFilter() {
  ...
  return <div className="bg-card text-card-foreground rounded-xl shadow-sm border border-border p-4 sm:p-6">
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <div className="relative w-full sm:w-auto">
        ...
        <select
          ...
          className="w-full pl-10 pr-8 h-10 border border-input rounded-md bg-background ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        >
